...
from chatrooms import global_init as chatrooms_global_init
...
class GlobalVars:
    ...
    no_chat = 'no_chat' in sys.argv[1:]
    charcoal_only = 'charcoal-hq-only' in sys.argv[1:]
    chatrooms = chatrooms_global_init(no_chat=no_chat, charcoal_only_charcoal_only)
